...
| 3b | Stage 1 | Language-keyed normalization (moved here from old Phase 8 / H.5 — Part K, K1) | **IN PROGRESS** — Owner: project owner (assigned 2026-08-15, execution order 3b → 3c → Phase 3 production wiring → Stage 1 lock). Rule 1 (French elision) DONE 2026-08-15 (Phase 3b Slice 2, `docs/work-in-progress.md` changelog); number words, currency, thousands separators not yet started. | `src/services/faTextNormalize.test.ts` + `src-tauri/src/fa/text.rs` fixture-parity gate (French elision only) | 2026-08-15 |
