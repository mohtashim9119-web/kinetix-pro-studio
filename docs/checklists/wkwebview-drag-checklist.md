...
`docs/ws3-video-segments/video-segment-investigation.md`. The third — symptom 2, the `duration`↔
...
| 12 | **DEFERRED properly.** Parked in `docs/ws3-video-segments/video-segment-investigation.md` with its three symptoms separated. Do not score this step. | No — do not run it as pass/fail; add observations to that document. |
