...
|---|---|---|---|---|---|
| 0 | Programme | Safety and instruments (corpus verification, determinism check, script-word-keyed verification set, baseline CSV) | DONE | Owner | 2026-08-03 |
...
- **Controls: PASS** — all 20 control rows (see `case_type` breakdown in `verification-baseline.csv`) listened, all correct.
