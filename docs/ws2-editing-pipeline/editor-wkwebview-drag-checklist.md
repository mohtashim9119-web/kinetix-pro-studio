...
**RULED WONTFIX 2026-08-08** — unreachable through normal UI use; see `docs/archive/history/work-in-progress.md`'s
...
Step 13 (drawer slip bar, unknown asset duration): PASS / FAIL   Notes: __________
