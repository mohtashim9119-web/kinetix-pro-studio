...
The v2 sync-pipeline architecture plan (`docs/sync-pipeline-v2-plan.md`) is **accepted** (2026-08-03) as the path forward for the word-shift defect. **Phase 0 (safety/instruments) is the next action** — no v2 implementation has started yet.
...
|---|---|---|
| `docs/sync-pipeline-v2-plan.md` | The accepted 4-stage sync-pipeline restructure (Phases 0-7) — the live plan for all future sync-timing work. | **Live plan, accepted 2026-08-03, pre-implementation.** |
| `docs/sync-pipeline-contract-plan.md` | The Pipeline Contract Program's assumption tables and risk register (R1-R14) — not restated anywhere else. | **Paused**, superseded in sequencing by v2 (its validator concepts absorb into v2 Phase 7). |
