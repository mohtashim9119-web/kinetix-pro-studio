...
const KNOWN_BAD: KnownBadRow[] = [
  ...
  },
  {
    ...
    note: 'Confirms the session brief\'s own question: a silence-based (not chunk-edge-based) detector ' +
      ...
      'speaks 683.04-683.84 — `docs/archive/history/history-2.md`\'s Session AH entry). R.14 reaches ' +
  ...
  // -------------------------------------------------------------------------
  {
    ...
    note: 'THE 383 REVERSAL. Was `verification: \'ear\'` at 1188.95 (`live-runs-s`, a solo listen). ' +
      '`ear-verify-t`\'s A/B comparison (`docs/archive/history/history-2.md`\'s Session T entry) reverses ' +
...
const REGISTER_ROSTER = [
  ...
  // guilt cuts both ways. It is row 1 of `docs/archive/history/history-2.md`'s Session K entry.
...
const CLOSED_BY_POSITIVE_ASSERTION: Array<{
  ...
  },
  {
    ...
    why: 'R.13 (the atomic-utterance invariant — the CLOSING half of R.12). R.12 pulled ' +
      ...
      'row 1 of `docs/archive/history/history-2.md`\'s Session K entry and is admitted here on ' +
