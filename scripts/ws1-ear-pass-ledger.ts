...
export const EAR_SITTINGS = {
   ...
   *  Section A (9 rows, `docs/archive/history/history-2.md`'s Session W entry
   ...
   *
   *  The operator worked through the Session AG ear list (`docs/archive/history/history-2.md`) — every v6
...
export const EAR_PASS_LEDGER: readonly EarPassRow[] = [
  ...
  // -------------------------------------------------------------------------
  // WS1 SESSION T — A/B side-by-side pass (`docs/archive/history/history-2.md`'s Session T
  ...
  { sitting: 'ear-verify-ad', corpus: 'v6', tag: '231_slowing_pace', scoredValue: 682.74, verdict: 'CORRECT',
    note: 'Row 2 target. A/B-confirmed CORRECT — the THIRD option in a three-way choice ' +
      '(Session AC ear list, `docs/archive/history/history-2.md`, row 2: A=680.99 a naive nearest-silence detector\'s own ' +
  ...
  { sitting: 'ear-verify-ag', corpus: 'v6', tag: '231_slowing_pace', scoredValue: 682.740, verdict: 'CORRECT',
    note: 'THE GUARD\'S FALSE NEGATIVE, and an independent re-confirmation of `ear-verify-ad`\'s own target ' +
      ...
      '(`docs/archive/history/history-2.md`\'s Session AH entry) puts segment 231\'s speech at ' +
...
// used as a validation set. The Session AG ear list (`docs/archive/history/history-2.md`) was generated with
