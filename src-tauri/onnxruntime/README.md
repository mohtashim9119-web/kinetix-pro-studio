...
`docs/ws2-editing-pipeline/fa-models-ort-provisioning.md` for what's still unverified on each.
...
`docs/ws2-editing-pipeline/fa-models-ort-provisioning.md` for what is and isn't verified about
that.
