...
describe('canLeaveDegradedRelinkFlow — extends the no-save invariant', () => {
  ...
  it('agrees with canPersistRecoveredProject: not written ≡ still unresolved', () => {
    ...
    expect(canPersistRecoveredProject({
      assets: [
        { id: 'a1', name: assetA.name, unresolved: true },
        { id: 'a2', name: assetB.name, unresolved: true },
      ],
      segments: [
    ...
    expect(canPersistRecoveredProject({
      assets: [
        { id: 'a1', name: assetA.name, unresolved: false },
        { id: 'a2', name: assetB.name, unresolved: false },
      ],
      segments: [
