...
function attributeByIndex(
  ...
  // `docs/archive/history/history-2.md`'s Session AH entry (ruling R-AS).
...
// audit (ruling R-AS: `docs/archive/history/history-2.md`'s Session AH entry). S2 tries to
...
// someone else's words (`docs/archive/history/history-2.md`'s Session AH entry — text filed
...
// (`docs/archive/history/history-2.md`'s Session AH entry, R.5 recitation-census note); a wide S2 chunk that
