...
// ---------------------------------------------------------------------------
// WS3 item G — estimateExportDestinationDiskBytes, folded in from the
// formerly-dead exportDestinationDiskEstimate.ts (moved here verbatim, WS3
// STEP 6's owner-specified formula, unchanged). The 28-minute (1680 s)
// 1080p30 triplet is the owner-specified exact check: get any of these three
// numbers wrong and this fails loudly rather than silently under- or
// over-estimating a real save.
// ---------------------------------------------------------------------------
