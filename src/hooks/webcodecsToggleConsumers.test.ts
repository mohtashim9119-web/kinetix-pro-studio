...
const ALLOWED: ReadonlyArray<{ path: string; why: string }> = [
  ...
  {
    path: 'dev/exportLivenessProbe/runCeilingBisect.ts',
    why: 'dev-only Round 3 ceiling-bisect harness under src/dev/, same reach as runLiveExport',
  },
  {
  ...
  {
    path: 'dev/exportLivenessProbe/runPartC.ts',
    why: 'dev-only Part C transitioned/animated-fixture harness under src/dev/, same reach as runRound6',
  },
];
