...
/**
 * Path B — separate heading layer (docs/archive/history/history.md ("Path B — Separate Heading Layer — Design Decisions", archived), Decision 1).
...
export interface TranscriptToken {
   ...
   *  script; TIME IS NOT — see `docs/archive/history/work-in-progress.md` §4's word-timing-
...
export interface Project {
  ...
  /** Path B heading layer (docs/archive/history/history.md ("Path B — Separate Heading Layer — Design Decisions", archived)) — the sole
