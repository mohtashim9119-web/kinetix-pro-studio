...
interface Props {
  ...
  /** Path B (docs/archive/history/history.md ("Path B — Separate Heading Layer — Design Decisions", archived)) — top-level heading overlays,
...
export function DropZonePanel({
  ...
  // (Path B, docs/archive/history/history.md ("Path B — Separate Heading Layer — Design Decisions", archived) Phase 5, Decision 3) — row
